...
```
import { aadAnotherAppClient } from "relative_path_to_this_file";
...
const teamsFx = new TeamsFx(IdentityType.App, {
  ...
  // TODO: Please add your client secret to .env.teamsfx.local before local debugging.
...
const aadAnotherAppClient = createApiClient(
  teamsFx.getConfig("TEAMSFX_API_AADANOTHERAPP_ENDPOINT"),
  authProvider
);
export { aadAnotherAppClient };
