...
```
const { apiKeyHeaderClient } = require("relative_path_to_this_file");
...
const authProvider = new teamsfxSdk.ApiKeyProvider(
  "user_inputted_header_name",
  teamsFx.getConfig("TEAMSFX_API_APIKEYHEADER_API_KEY"),
  teamsfxSdk.ApiKeyLocation.Header
);
const apiKeyHeaderClient = teamsfxSdk.createApiClient(
  teamsFx.getConfig("TEAMSFX_API_APIKEYHEADER_ENDPOINT"),
  authProvider
);
module.exports.apiKeyHeaderClient = apiKeyHeaderClient;
