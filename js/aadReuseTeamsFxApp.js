...
```
const { aadReuseCurrentAppClient } = require("relative_path_to_this_file");
...
const aadReuseCurrentAppClient = teamsfxSdk.createApiClient(
  teamsFx.getConfig("TEAMSFX_API_AADREUSECURRENTAPP_ENDPOINT"),
  authProvider
);
module.exports.aadReuseCurrentAppClient = aadReuseCurrentAppClient;
